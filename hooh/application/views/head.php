<head>
    ...
    <title>Tempurharjo | Dashboard</title>
    ...
    <!-- Favicon -->
    <link href="<?=base_url('asset/dist/img/screw.ico')?>" rel="icon">
    <!-- Ionicons -->
    ...
    <!-- CodeMirror -->
    <link rel="stylesheet" href="<?=base_url('asset/plugins/codemirror/codemirror.css')?>">
    <link rel="stylesheet" href="<?=base_url('asset/plugins/codemirror/theme/monokai.css')?>">
    <!-- SimpleMDE -->
    <link rel="stylesheet" href="<?=base_url('asset/plugins/simplemde/simplemde.min.css')?>">
  </head>